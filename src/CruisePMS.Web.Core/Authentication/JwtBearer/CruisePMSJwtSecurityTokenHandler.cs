...
namespace CruisePMS.Web.Authentication.JwtBearer
{
    public class CruisePMSJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public CruisePMSJwtSecurityTokenHandler()
        {
