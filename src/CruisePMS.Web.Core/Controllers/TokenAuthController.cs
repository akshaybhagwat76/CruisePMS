...
using CruisePMS.Web.Models.TokenAuth;
using CruisePMS.Authorization.Impersonation;
...
using CruisePMS.Web.Authentication.External;
...
namespace CruisePMS.Web.Controllers
{
    ...
    public class TokenAuthController : CruisePMSControllerBase
    {
