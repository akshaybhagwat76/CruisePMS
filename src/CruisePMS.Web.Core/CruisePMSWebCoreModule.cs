...
using CruisePMS.Web.Authentication.JwtBearer;
using CruisePMS.Web.Authentication.TwoFactor;
using CruisePMS.Web.Chat.SignalR;
using CruisePMS.Web.Configuration;
using CruisePMS.Web.DashboardCustomization;

namespace CruisePMS.Web
{
    [DependsOn(
        typeof(CruisePMSApplicationModule),
        typeof(CruisePMSEntityFrameworkCoreModule),
    ...
    public class CruisePMSWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CruisePMSWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(CruisePMSApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CruisePMSWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(CruisePMSWebCoreModule).Assembly);
        }
