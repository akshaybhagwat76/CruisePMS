...
using CruisePMS.Url;
using CruisePMS.Web.Public.Startup;
using CruisePMS.Web.Session;

namespace CruisePMS.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : CruisePMSViewComponent
    {
