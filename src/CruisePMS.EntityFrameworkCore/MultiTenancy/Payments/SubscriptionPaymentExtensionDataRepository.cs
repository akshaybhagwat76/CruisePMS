...
using CruisePMS.EntityFrameworkCore.Repositories;

namespace CruisePMS.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : CruisePMSRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<CruisePMSDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
