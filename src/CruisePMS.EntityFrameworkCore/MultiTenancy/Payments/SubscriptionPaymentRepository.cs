...
{
    public class SubscriptionPaymentRepository : CruisePMSRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<CruisePMSDbContext> dbContextProvider)
