...
using MvvmHelpers;
using CruisePMS.Authorization.Users.Profile;
...
using CruisePMS.Services.Navigation;
...
using CruisePMS.ApiClient;
using CruisePMS.Controls;
using CruisePMS.Dto;
using CruisePMS.Extensions;
using CruisePMS.Localization;
using CruisePMS.UI;
using CruisePMS.UI.Assets;
using CruisePMS.Views;
using DependencyResolver = CruisePMS.Core.Dependency.DependencyResolver;
...
namespace CruisePMS.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "CruisePMS";
