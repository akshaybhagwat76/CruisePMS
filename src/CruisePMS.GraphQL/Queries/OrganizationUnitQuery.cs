...
using CruisePMS.Core.Base;
using CruisePMS.Core.Extensions;
using CruisePMS.Dto;
using CruisePMS.Types;

namespace CruisePMS.Queries
{
    public class OrganizationUnitQuery : CruisePMSQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
