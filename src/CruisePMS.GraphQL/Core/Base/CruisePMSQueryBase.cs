...
namespace CruisePMS.Core.Base
{
    public abstract class CruisePMSQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected CruisePMSQueryBase(string fieldName,
