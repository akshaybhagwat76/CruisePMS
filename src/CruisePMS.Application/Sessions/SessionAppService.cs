...
{
    public class SessionAppService : CruisePMSAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = CruisePMSConsts.Currency,
                    CurrencySign = CruisePMSConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = CruisePMSConsts.AllowTenantsToChangeEmailSettings,
