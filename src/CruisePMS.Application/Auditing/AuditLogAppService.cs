...
using CruisePMS.Auditing.Exporting;
using CruisePMS.Authorization;
using CruisePMS.Authorization.Users;
using CruisePMS.Dto;
using CruisePMS.EntityHistory;
using EntityHistoryHelper = CruisePMS.EntityHistory.EntityHistoryHelper;

namespace CruisePMS.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : CruisePMSAppServiceBase, IAuditLogAppService
    {
