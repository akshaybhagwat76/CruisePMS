...
using CruisePMS.DemoUiComponents.Dto;

namespace CruisePMS.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : CruisePMSAppServiceBase, IDemoUiComponentsAppService
    {
