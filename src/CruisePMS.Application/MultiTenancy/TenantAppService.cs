...
namespace CruisePMS.MultiTenancy
{
    ...
    public class TenantAppService : CruisePMSAppServiceBase, ITenantAppService
    {
        ...
        {
            var teantId = await TenantManager.CreateWithAdminUserAsync(input.TenancyName,
                   input.Name,
                   input.AdminPassword,
                   ...
                   AppUrlService.CreateEmailActivationUrlFormat(input.TenancyName), input.TenantType
               );

            await UpdateAllTenantPermission(teantId, input.TenantType);
        }
        ...
        private async Task UpdateGrantedPermissionsAsync(Role role, List<string> grantedPermissionNames)
        {
            ...
            await TenantManager.SetGranterPermissionByRoleAsync(role, grantedPermissions);
        }
        ...
        public async Task UpdateTenant(TenantEditDto input)
        {
            ...
            await UpdateAllTenantPermission(tenant.Id, input.TenantType);
