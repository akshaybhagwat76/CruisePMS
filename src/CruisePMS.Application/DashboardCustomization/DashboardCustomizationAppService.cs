...
using CruisePMS.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace CruisePMS.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : CruisePMSAppServiceBase, IDashboardCustomizationAppService
    {
