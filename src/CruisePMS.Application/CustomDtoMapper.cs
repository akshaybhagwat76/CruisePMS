...
using CruisePMS.Localization.Dto;
...
using CruisePMS.Notifications.Dto;
using CruisePMS.Organizations.Dto;
using CruisePMS.Sessions.Dto;
using CruisePMS.WebHooks.Dto;
...
namespace CruisePMS
{
    internal static class CustomDtoMapper
    {
        ...
        {
            configuration.CreateMap<CreateOrEditMasterAmenitiesDto, MasterAmenities>().ReverseMap();
            configuration.CreateMap<MasterAmenitiesDto, MasterAmenities>().ReverseMap();
            //Inputs
