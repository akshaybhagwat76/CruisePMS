...
using CruisePMS.Authorization.Users.Profile.Cache;
using CruisePMS.Authorization.Users.Profile.Dto;
using CruisePMS.Friendships;
using CruisePMS.Gdpr;
using CruisePMS.Identity;
using CruisePMS.Net.Sms;
using CruisePMS.Security;
using CruisePMS.Storage;
using CruisePMS.Timing;

namespace CruisePMS.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : CruisePMSAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("CruisePMS",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("CruisePMS",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
