...
using CruisePMS.Migrations.Seed.Host;
...
namespace CruisePMS.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : CruisePMSAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<CruisePMSDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(CruisePMSConsts.ConnectionStringName).Value.ToString();
        }
