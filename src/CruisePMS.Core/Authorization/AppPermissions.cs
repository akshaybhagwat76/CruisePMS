namespace CruisePMS.Authorization
{
    ...
    {
        public const string Pages_MasterAmenitieses = "Pages.MasterAmenitieses";
        public const string Pages_MasterAmenitieses_Create = "Pages.MasterAmenitieses.Create";
        public const string Pages_MasterAmenitieses_Edit = "Pages.MasterAmenitieses.Edit";
        public const string Pages_MasterAmenitieses_Delete = "Pages.MasterAmenitieses.Delete";

        public const string Pages_TenantTypes = "Pages.TenantTypes";
        public const string Pages_TenantTypes_Create = "Pages.TenantTypes.Create";
