...
using CruisePMS.Authorization.Ldap;
using CruisePMS.Authorization.Roles;
using CruisePMS.Authorization.Users;
using CruisePMS.Chat;
using CruisePMS.Configuration;
using CruisePMS.DashboardCustomization.Definitions;
using CruisePMS.Debugging;
using CruisePMS.DynamicEntityParameters;
using CruisePMS.Features;
using CruisePMS.Friendships;
using CruisePMS.Friendships.Cache;
using CruisePMS.Localization;
using CruisePMS.MultiTenancy;
using CruisePMS.Net.Emailing;
using CruisePMS.Notifications;
using CruisePMS.WebHooks;

namespace CruisePMS
{
    [DependsOn(
        typeof(CruisePMSCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class CruisePMSCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            CruisePMSLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = CruisePMSConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, CruisePMSMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<CruisePMSSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CruisePMSCoreModule).GetAssembly());
        }
