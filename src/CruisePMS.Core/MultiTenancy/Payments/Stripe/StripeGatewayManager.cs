...
{
    public class StripeGatewayManager : CruisePMSServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "CruisePMS";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + CruisePMSConsts.Currency;
        }
